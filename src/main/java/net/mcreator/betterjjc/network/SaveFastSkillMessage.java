...
import net.mcreator.betterjjc.procedures.SaveFastSkillKeyReleasedProcedure;
import net.mcreator.betterjjc.procedures.SaveFastSkillKeyPressedProcedure;
...
public class SaveFastSkillMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SaveFastSkillKeyPressedProcedure.execute(entity);
		}
		if (type == 1) {

			SaveFastSkillKeyReleasedProcedure.execute(entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		BetterjjcMod.addNetworkMessage(SaveFastSkillMessage.class, SaveFastSkillMessage::buffer, SaveFastSkillMessage::new, SaveFastSkillMessage::handler);
	}
}
