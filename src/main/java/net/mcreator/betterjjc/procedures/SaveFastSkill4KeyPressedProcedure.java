...
public class SaveFastSkill4KeyPressedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getPersistentData().getBoolean("SaveFastSkill_PRESSED")) {
			if ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerSelectCurseTechnique != 20) {
				entity.getPersistentData().putDouble("FastSkill4_CurseTechnique", (entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCurseTechnique);
				entity.getPersistentData().putDouble("FastSkill4_SelectCurseTechnique",
				...
				entity.getPersistentData().putDouble("FastSkill4_SelectCurseTechniqueCost",
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Saved the current skill in the \u00A7lfourth slot"), false);
			}
		} else if (entity.getPersistentData().getBoolean("CombatMode")) {
			if (entity.getPersistentData().getDouble("FastSkill4_CurseTechnique") == (entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCurseTechnique
					&& entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique") != 0 && entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique") != 20) {
				if (entity instanceof LivingEntity && ((LivingEntity) entity).hasEffect(JujutsucraftModMobEffects.UNSTABLE.get()) == false && entity instanceof LivingEntity
					...
					if ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCursePower >= entity.getPersistentData()
							.getDouble("FastSkill4_SelectCurseTechniqueCost")) {
						if (entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique") < 10) {
							...
							}.convert(Math.round(entity.getPersistentData().getDouble("FastSkill4_CurseTechnique")) + "" + Math.round(0) + Math.round(entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique"))));
						} else if (entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique") < 10) {
							entity.getPersistentData().putDouble("skill", new Object() {
								double convert(String s) {
									try {
										return Double.parseDouble(s.trim());
							...
							}.convert(Math.round(entity.getPersistentData().getDouble("FastSkill4_CurseTechnique")) + "" + Math.round(entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechnique"))));
						}
						{
							double _setval = ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCursePower
									- entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechniqueCost"));
						...
						ticks = Math.round(entity.getPersistentData().getDouble("FastSkill4_SelectCurseTechniqueCost") / 35);
						{
							Entity _ent = entity;
							if (!_ent.level().isClientSide() && _ent.getServer() != null) {
								_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
