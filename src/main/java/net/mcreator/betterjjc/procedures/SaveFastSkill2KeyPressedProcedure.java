...
public class SaveFastSkill2KeyPressedProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (entity.getPersistentData().getBoolean("SaveFastSkill_PRESSED")) {
			if ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerSelectCurseTechnique != 20) {
				entity.getPersistentData().putDouble("FastSkill2_CurseTechnique", (entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCurseTechnique);
				entity.getPersistentData().putDouble("FastSkill2_SelectCurseTechnique",
				...
				entity.getPersistentData().putDouble("FastSkill2_SelectCurseTechniqueCost",
				...
				if (entity instanceof Player _player && !_player.level().isClientSide())
					_player.displayClientMessage(Component.literal("Saved the current skill in the \u00A7lsecond slot"), false);
			}
		} else if (entity.getPersistentData().getBoolean("CombatMode")) {
			if (entity.getPersistentData().getDouble("FastSkill2_CurseTechnique") == (entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCurseTechnique
					&& entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique") != 0 && entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique") != 20) {
				if (entity instanceof LivingEntity && ((LivingEntity) entity).hasEffect(JujutsucraftModMobEffects.UNSTABLE.get()) == false && entity instanceof LivingEntity
					...
					if ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCursePower >= entity.getPersistentData()
							.getDouble("FastSkill2_SelectCurseTechniqueCost")) {
						if (entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique") < 10) {
							...
							}.convert(Math.round(entity.getPersistentData().getDouble("FastSkill2_CurseTechnique")) + "" + Math.round(0) + Math.round(entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique"))));
						} else if (entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique") < 10) {
							entity.getPersistentData().putDouble("skill", new Object() {
								double convert(String s) {
									try {
										return Double.parseDouble(s.trim());
							...
							}.convert(Math.round(entity.getPersistentData().getDouble("FastSkill2_CurseTechnique")) + "" + Math.round(entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechnique"))));
						}
						{
							double _setval = ((entity.getCapability(JujutsucraftModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new JujutsucraftModVariables.PlayerVariables())).PlayerCursePower
									- entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechniqueCost"));
						...
						ticks = Math.round(entity.getPersistentData().getDouble("FastSkill2_SelectCurseTechniqueCost") / 35);
						{
							Entity _ent = entity;
							if (!_ent.level().isClientSide() && _ent.getServer() != null) {
								_ent.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, _ent.position(), _ent.getRotationVector(), _ent.level() instanceof ServerLevel ? (ServerLevel) _ent.level() : null, 4,
